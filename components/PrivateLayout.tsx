...
export const PrivateLayout = ({ children, allowedRoles }: PrivateLayoutProps) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-island-base overflow-hidden font-sans print:bg-white print:h-auto print:overflow-visible">
      {/* Global Header - Persistent across public and private pages - Hidden on Print */}
      <div className="print:hidden">
        <Header transparent={false} />
      </div>

      <div className="flex flex-1 overflow-hidden relative p-4 gap-4 print:p-0 print:block">
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden relative rounded-3xl bg-white shadow-sm border border-island-sand/50 print:border-none print:shadow-none print:bg-transparent print:h-auto print:overflow-visible">

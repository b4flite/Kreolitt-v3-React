        ...
        <div className="flex items-center space-x-6 md:space-x-8">
          <Link 
            ...
            className={`font-medium text-sm md:text-base transition-colors ${
              transparent ? 'text-white/90 hover:text-white' : 'text-gray-600 hover:text-sey-blue'
            }`}
          >
            Home
          </Link>
          ...
          <Link
            to={action.path}
             className={`px-5 py-2.5 text-sm md:text-base font-semibold rounded-full transition-all duration-300 transform hover:-translate-y-0.5 ${
               transparent

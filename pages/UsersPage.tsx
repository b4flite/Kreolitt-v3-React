...
const UsersPage: React.FC = () => {
  ...
  const { data: result, isLoading } = useQuery({
    queryKey: ['users', page],
    queryFn: () => userService.getAllUsers(page, pageSize),
    enabled: !!currentUser
  });
  ...
  return (
    <div>
      ...
      <div className="bg-white shadow-sm rounded-xl overflow-hidden border border-gray-200">
        ...
        {totalPages > 1 && (
          <div className="flex justify-between items-center px-6 py-4 bg-gray-50/50 border-t border-gray-200 print:hidden">
            <button
